...
public class MahasiswaApp extends JFrame {
    ...
    public MahasiswaApp() {
        ...
        // Gabungkan panel cari ke panelAtas (agar posisinya di bawah tombol CRUD)
    ...
    private void tambahData() {
        ...
        if (isNIMExist(txtNIM.getText())) {
            JOptionPane.showMessageDialog(this, "NIM sudah terdaftar! Gunakan NIM lain.", "Error Validasi", JOptionPane.WARNING_MESSAGE);
    ...
    private void ubahData() {
        try {
            ...
            pst.setString(3, txtNIM.getText()); // Kunci update (WHERE nim=...)
    ...
    // Method Helper untuk Cek Duplikasi NIM (Latihan 4)
